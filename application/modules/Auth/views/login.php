    	...
    	<!-- Logo //end-->
        	<div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form id="loginform" class="" role="form" data-toggle="validator" method="post" action="<?php echo base_url('auth/do_login'); ?>">

                    	<div class="form-group has-feedback">
	                    	<div class="input-group">
    	                        <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
        	                    <input type="email" class="form-control" name="email" placeholder="<?php echo $this->lang->line('auth_login_form_email_placeholder')?>" required autofocus>
            	            </div>
  						...
  						<div class="form-group has-feedback">
	                        <div class="input-group">
	                            ...
	                            <input type="password" class="form-control" name="password" placeholder="<?php echo $this->lang->line('auth_login_form_password_placeholder')?>" required id="password">
	                        </div>
	                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
    						<div class="help-block with-errors"></div>
