<div class="subnav">
	<div class="container-fluid">
    	<h1><span class="glyphicon glyphicon-question-sign"></span> Question Answer Management</h1>

        <div id="sub-menu" class="pull-right">
        	<ul class="nav nav-pills">
        		<li class="active"><a href="<?php echo base_url('App/questions_answers');?>"><span class="glyphicon glyphicon-question-sign"></span> Question Answer</a></li>
	    ...
	    <table class="table table-striped table-responsive" width="100%" id="user-table">
	        ...
	        <tbody>
	            ...
	            <tr>
	            	...
	            	<td><?php if($item->answer_type!=''){echo ucfirst($item->answer_type);}?></td>
	            	...
	            	<td>
	            		...
	            		<a class="btn btn-danger btn-xs" href="<?php echo base_url('App/questions_answers/delete/'.$item->id);?>" onclick="return confirm('Are you sure you want to delete the record?');" title="Delete">
