<div class="subnav">
	<div class="container-fluid">
    	<h1><span class="glyphicon glyphicon-question-sign"></span>Create Question Answers</h1>
    		...
    		<legend>Questions</legend>
		  	...
		  	<div class="form-group">
		  		...
		  		<div class="col-sm-9">
					...
					<textarea name="question" class="form-control" id="question" placeholder="Type your question" required rows="4"><?php echo set_value('question'); ?></textarea>
