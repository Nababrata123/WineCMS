<div class="subnav">
	<div class="container-fluid">
    	<h1><span class="glyphicon glyphicon-sales_representative"></span> Edit Sales Representative &raquo; <small> <?php echo $sales_representative->first_name." ".$sales_representative->last_name;?></small></h1>
        <div id="sub-menu" class="pull-right">
        	<ul class="nav nav-pills">
        		<li><a href="<?php echo base_url('App/sales_representative');?>"><span class="glyphicon glyphicon-sales_representative"></span> Sales Representative</a></li>
		...
		<fieldset>
    		<legend>Basic Info</legend>
		  	...
		  	<div class="form-group">
		  		...
		  		<div class="col-sm-7">
		  			<input type="text" name="first_name" class="form-control nf" id="inputFirstName" placeholder="Enter first name" value="<?php echo $sales_representative->first_name;?>" required>
			...
			<div class="form-group">
		  		...
		  		<div class="col-sm-7">
		  			<input type="text" name="last_name" class="form-control nf" id="inputLastName" placeholder="Enter last name" value="<?php echo $sales_representative->last_name;?>" required>
		  			<div class="help-block with-errors"></div>
		  		</div>
		  	</div>
		  	...
		  	<div class="form-group">
		  		...
		  		<div class="col-sm-7">
			  		<input type="email" name="email" class="form-control" id="inputEmail" placeholder="Enter email address" value="<?php echo $sales_representative->email;?>" required readonly>
			  		<div class="help-block with-errors"></div>
			  	</div>
		  	</div>
