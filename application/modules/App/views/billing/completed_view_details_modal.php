    ...
    <div class="modal-content">
     ...
     <div class="form-group">
          ...
          <?php
            ...
            <div class="col-sm-3"><?php if($job->finish_time != '00:00:00'){ echo $end_hour,':',$end_minute,' ',$end; }else{ echo 'N/A'; } ?></div>
            </div>
          </div>
          ...
          <?php foreach($store as $value){ ?>
                <?php if($value['id']==$job->store_id){ ?>
							    <div class="col-sm-3"><?php echo $value['zipcode'];?></div>
								<?php 
								break; 
								 } ?>
					  <?php } ?>
          ...
          <div class="row">
            ...
            <div class="col-sm-3"><?php echo $taster_name ?></div>
          </div>
          </div>
        ...
        <div class="col-md-12">
				<table border="1" width="100%">
					<tr>
						...
						<th style="text-align:center; width:100px;">Sampled</th>
            <th style="text-align:center; width:180px;">Opened Bottles Sampled</th>
						<th style="text-align:center; width:100px;">Sold</th>
					</tr>
					<?php 
					...
					<tr>
						...
						<td style="text-align:center; width:100px;"><?php echo $value['bottles_sampled'];?></td>
            <td style="text-align:center; width:180px;"><?php echo $value['open_bottles_sampled'];?></td>
						<td style="text-align:center; width:100px;"><?php echo $value['bottles_sold'];?></td>
					</tr>
					<?php
						}
					}else{
					?>
						<tr>
							<td colspan="4" style="text-align:center;">No wine sampled</td>
						</tr>
					<?php
					}
					?>
...
<!-- Name Comment -->
         <div class="col-md-12">
            ...
            <div class="col-sm-3"><?php if(isset($manager_verification_details[0]['first_name'])){echo $manager_verification_details[0]['first_name']." ".$manager_verification_details[0]['last_name'];}else{ echo 'N/A'; }?></div>
        ...
        <!-- Expense Amount -->
          ...
          <div class="col-sm-3"><?php 
            if(count($expense_details)>0){
              ...
              if($expense_amount != ''){ echo $expense_amount; }else{ echo "N/A"; }
            }else{
              echo "N/A";
            }
              ?></div>
           ...
           <div class="col-sm-3"><?php
             if(count($expense_details)>0){
              if($expense_details[0]['exp_reason'] != ''){echo $expense_details[0]['exp_reason']; }else{ echo "N/A"; }
             }else{
              echo "N/A";
             }
               ?></div>
            ...
            <?php 
              if(count($expense_details)>0){
                if(count($expense_details[0]['support_imgs'])>0){
                  ...
                  <?php if($imgindx != ''){?>
                    <?php echo '<div class="col-md-2"><img data-enlargeable style="cursor: zoom-in; height: 100px; width: 100px;" src="'.BASE_URL.DIR_EXPENSE_IMAGE.$imgindx.'"> </div>'; ?>
                  <?php } else{ echo '<div class="col-sm-3"> No images available</div>';}?>
               <?php } }else{ echo '<div class="col-sm-3"> No images available</div>';}?>
             <?php } else { ?>
             <?php echo '<div class="col-sm-3"> No images available</div>'; ?>
            <?php } ?>
