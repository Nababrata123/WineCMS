    ...
    <tr>
      ...
      <th style="padding: 5px;" width="25%" align="left"># of Bottles Used</th>
      <th style="padding: 5px;" width="25%" align="left"># of Opened Bottles Used</th>
      <th style="padding: 5px;" width="25%" align="left"># of Bottles Sold</th>
      <th style="padding: 5px;" width="25%" align="left">Cost Per Tasting</th>
        ...
        ?>
     <tr>
          <td style="padding: 5px;"><?php echo ucfirst($val['name']);?>&nbsp; 
          <?php 
         ...
         <td><center><?php echo $val['open_bottles_sampled']?></center></td>
     ...
     <tr>
       ...
       <td><center><strong><?php echo $total_opened;?></strong></center></td>
