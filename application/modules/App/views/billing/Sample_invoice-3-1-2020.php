...
<table width="100%" cellpadding="0" cellspacing="0">
 ...
 <tr>
   <td>
    ...
    <tr>
      ...
      <th width="25%" align="left"># of Bottles Used</th>
      <th width="25%" align="left"># Bottles Sold</th>
      <th width="25%" align="left">Cost Per Tasting</th>
     </tr>
        <?php
            $total_sampled=0;
            $total_sold=0;
     ...
     <tr>
          ...
          <td><?php echo $val['bottles_sampled']?></td>
          <td><?php echo $val['bottles_sold']?></td>
          <td>$<?php echo $individual_amount;?></td>
     </tr>
        <?php
            }
        ?>
     <tr>
       ...
       <td><strong><?php echo $total_sampled;?></strong></td>
       <td><strong><?php echo $total_sold;?></strong></td>
       <td>
           <strong>
               <?php 
 ...
 <tr>
   <td>
    <table width="100%">
     <tr>
      <td width="50%"><strong><u><?php echo $more_job_info->taster_id;?></u></strong> <br />Taster #</td>
      <td width="50%">
       <strong><u><?php echo $more_job_info->taster_name;?></u></strong><br />
