    ...
    <div class="modal-content">
     ...
     <div class="col-sm-12">
      <fieldset>
        ...
        <div class="form-group">
          <label for="inputConfirmPassword" class="col-sm-3 control-label">Taster Feedback </label>
          <div class="col-sm-7"> 
                      <textarea name="Comments" class="form-control" id="Comments"  placeholder="Taster Feedback"  ><?php if ($manager_verification_details[0]['comment']!= null ) { echo $manager_verification_details[0]['comment'];?> <?php } ?></textarea>
            <div class="help-block with-errors"></div>
          </div>
        </div>
