      ...
      <div class="col-sm-12">
         ...
         <div class="col-md-3">
          <div class="form-group" style="width:100%;">
            ...
            <select name="brand[]" id="inputField" class="selectpicker" multiple data-live-search="true" data-live-search-placeholder="Search" data-actions-box="true" style="width:100%;">
              <?php
          ...
          <div class="col-md-3">
                ...
                <select name="wine_type[]" id="inputField" class="selectpicker" multiple data-live-search="true" data-live-search-placeholder="Search" data-actions-box="true" data-width="100%">
            ...
            <div class="col-md-2">
                ...
                <select name="size[]" class="selectpicker" multiple data-live-search="true" data-live-search-placeholder="Search" data-actions-box="true" style="width:100%;">
                            <?php
           ...
           <div class="row">
            ...
            <select name="search_by_store[]" id="inputField" class="selectpicker" multiple data-live-search="true" data-live-search-placeholder="Search" data-actions-box="true" style="width:100%;">
        ...
        <div class="col-md-2">
                    <div class="form-group" style="width:100%;">
                        ...
                        <select name="taster[]" id="inputField" class="selectpicker" multiple data-live-search="true" data-live-search-placeholder="Search" data-actions-box="true" style="width:100%;">
            ...
            <div class="col-md-3">
                    <div class="form-group" style="width:100%;">
                        ...
                        <select name="agency[]" id="inputField" class="selectpicker" multiple data-live-search="true" data-live-search-placeholder="Search" data-actions-box="true" style="width:100%;">
            ...
            <div class="form-group" style="width:100%;">
                ...
                <select name="sales_rep[]" id="inputField" class="selectpicker" multiple data-live-search="true" data-live-search-placeholder="Search" data-actions-box="true" style="width:100%;">
                    <?php 
    ...
    <table class="table table-striped table-responsive" width="100%">
      ...
      <tbody>
        ...
        <td>
                ...
                <input type="checkbox" style="display: none;" name="item_id[<?php echo $details['job_id'];?>]" class="checkbox-item" value="<?php echo $details['job_id'];?>" checked></td>
