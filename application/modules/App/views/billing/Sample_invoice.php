...
<table width="100%" cellpadding="0" cellspacing="0">
         ...
         <td><table width="100%"><tr><td><strong><u><?php echo $date;?></u></strong></td></tr>
           ...
           // $actual_taken_time=$interval->format('%h')." Hours ".$interval->format('%i')." Minutes";
            $actual_taken_time=date("H", strtotime($more_job_info->working_hour))." Hours ".date("i", strtotime($more_job_info->working_hour))." Minutes";
             ...
             ?>
           <tr>
             <td><strong><u><?php  echo $actual_start_time;?> - <?php if($more_job_info->finish_time != '00:00:00'){ echo $actual_end_time;}else{ echo 'N/A'; }?> (<?php echo $actual_taken_time?>)</u></strong></td>
             </tr>
           <tr>
             <td>Time</td>
             </tr>
 ...
 <tr>
   <td>&nbsp;</td>
    ...
    <tr>
      <th width="25%" align="left">Wines Name</th>
      <th width="25%" align="center"># of Bottles Used</th>
      <th width="25%" align="center"># of Opened Bottles Used</th>
      ...
      <th width="25%" align="center">Cost Per Tasting</th>
        ...
        ?>
             <tr>
                  ...
                  <td align="center" ><?php echo $val['open_bottles_sampled']?></td>
     ...
     <tr>
       ...
       <td align="center" ><strong><?php echo $total_opened;?></strong></td>
