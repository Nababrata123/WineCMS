...
<div class="subnav">
  <div class="container-fluid">
    ...
    <div id="sub-menu" class="pull-right">
	  ...
	  <li class="active"><a href="<?php echo base_url('App/billing/get_expenses_brandwise')?>"><span class="glyphicon glyphicon-print"></span> Reports</a></li>
      </ul>
    </div>
  </div>
</div>
    ...
    <table class="table table-striped table-responsive" width="100%">
      ...
      <tbody>
        ...
        <tr id="job<?php echo $item->id;?>">
			...
			<td>
            <button type="button" style="width: 125px" class="btn btn-primary" onclick="edit_modal(<?php echo $item->id;?>)"><span class="glyphicon glyphicon-edit"></span> Edit Invoice</button>
            <button type="button" style="width: 125px" class="btn btn-warning" onclick="moveToArchive(<?php echo $item->id;?>);">Move to archive</button>
            </td>
            <!-- <td><a class="btn btn-primary btn-xs" href="javascript:void(0)" title="Edit"  onclick="edit_modal(<?php echo $item->id;?>)"><span class="glyphicon glyphicon-edit"></span>Edit</a>
            <button type="button" class="btn btn-warning" onclick="moveToArchive(<?php echo $item->id;?>);">Move to archive</button>
            </td> -->
