        ...
        <div class="form-group">
          ...
          <div class="col-md-12">
            ...
            <th style="text-align:center; width:180px;">Opened bottles sampled</th>
					...
					<tr>
						...
						<td style="text-align:center; width:100px;"><?php echo $val['bottles_sampled'];?></td>
            <td style="text-align:center; width:180px;"><?php echo $val['open_bottles_sampled'];?></td>
						<td style="text-align:center; width:100px;"><?php echo $val['bottles_sold'];?></td>
					</tr>
					<?php
						}
					}else{
          ...
          <div class="col-md-12">
            ...
            <div class="col-sm-8">
              ...
              <?php if($more_job_info->expense_reason!=''){
          ...
          <div class="row">
          <div class="col-md-12">
            <label class="col-sm-3 control-label">Taster's Feedback:</label>
            <div class="col-sm-8"><?php if($more_job_info->general_note!=''){echo $more_job_info->general_note;}else{echo "Not Available";}?></div>
          </div>
          </div>
          <div class="row">
          <div class="col-md-12">
            <label class="col-sm-3 control-label">Expense images:</label>
