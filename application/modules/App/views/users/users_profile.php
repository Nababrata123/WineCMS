...
<?php } ?>
	<?php
		...
		echo form_open(base_url('App/users/edit_profile/'.$user->id), $attributes);
    ?>
		...
		<fieldset>
			...
			<div class="form-group">
		  	...
		  	<div class="form-group">
		  		...
		  		<div class="col-sm-7">
			  		<!-- <input type="password" name="password" data-minlength="6" class="form-control" id="inputPassword" placeholder="Enter password N" > -->
		...
		<!-- <fieldset>
    		...
    		?>
              ...
              <!-- <div class="form-group">
		  		...
		  		<div class="col-sm-7">
			  		<input type="text" name="meta[phone]" data-minlength="10" maxlength="14" class="form-control" id="phone" placeholder="Enter phone number" value="<?php echo $user_meta[0]['meta_value']; ?>" >
			  ...
			  <div class="form-group">
                ...
                <div class="col-sm-7">
                    <input type="text" name="meta[adress]"  class="form-control" id="home_adress" placeholder="Enter address" value="<?php echo $user_meta[1]['meta_value']; ?>" required>
