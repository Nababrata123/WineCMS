      	...
      	<fieldset>
    		...
    		<input type="hidden" name="user_type" value="tester">
		  	<div class="form-group">
		  		...
		  		<div class="col-sm-7">
		  			<input type="text" name="first_name" class="form-control nf" id="inputFirstName" placeholder="Enter first name" value="<?php if(isset($allinput['first_name'])){echo $allinput['first_name'];} ?>" required>
			...
			<div class="form-group">
		  		...
		  		<div class="col-sm-7">
		  			<input type="text" name="last_name" class="form-control nf" id="inputLastName" placeholder="Enter last name" value="<?php if(isset($allinput['last_name'])){echo $allinput['last_name'];} ?>" required>
		  			<div class="help-block with-errors"></div>
		  		</div>
		  	</div>
	...
	<div class="col-sm-6">
		<fieldset>
            ...
            <div class="form-group">
		  		...
		  		<div class="col-sm-7">
			  		<input type="text" name="meta[city]"  class="form-control" id="city" placeholder="Enter city" value="<?php if(isset($allinput['city'])){echo $allinput['city'];} ?>">
            ...
            <div class="form-group">
		  		...
		  		<div class="col-sm-7">
			  		<input type="text" name="meta[state]"  class="form-control" id="state" placeholder="Enter state" value="<?php if(isset($allinput['state'])){echo $allinput['state'];} ?>" >
            ...
            <div class="form-group">
		  		...
		  		<div class="col-sm-7">
			  		<input type="text" name="meta[zipcode]"  class="form-control" id="zipcode" placeholder="Enter zipcode" value="<?php if(isset($allinput['zipcode'])){echo $allinput['zipcode'];} ?>">
            ...
            <div class="form-group">
		  		...
		  		<div class="col-sm-7">
                    ...
                    <textarea name="meta[address]"  class="form-control" id="address" placeholder="Enter address"><?php if(isset($allinput['address'])){echo $allinput['address'];} ?></textarea>
            ...
            <div class="form-group">
		  		...
		  		<div class="col-sm-7">
			  		<input type="text" name="meta[suite_number]"  class="form-control" id="suite_number" placeholder="Enter Suite or apartment number" value="<?php if(isset($allinput['suite_number'])){echo $allinput['suite_number'];} ?>">
            ...
            <!-- <div class="form-group">
    		 ...
    		 <div class="form-group">
		  		...
		  		<div class="col-sm-7">
			  		<input type="text" name="meta[phone]" data-minlength="10" maxlength="10" class="form-control" id="phone" placeholder="Enter phone number" value="<?php if(isset($allinput['phone'])){echo $allinput['phone'];} ?>">
		  	...
		  	<div class="form-group">
		  		...
		  		<div class="col-sm-7">
			  		<input type="number" name="meta[rate_per_hour]"  class="form-control" id="rate_per_hour" placeholder="Enter rate per hour" value="<?php if(isset($allinput['rate_per_hour'])){echo $allinput['rate_per_hour'];} ?>" required>
    		 ...
    		 <div class="form-group">
		  	...
		  	<div class="form-group">
		  		...
		  		<div class="col-sm-7">
			  		<input type="text" name="meta[manual_account_number]"  maxlength="10" class="form-control" id="manual_account_number" placeholder="Enter vendor number" value="<?php if(isset($allinput['vendor_number'])){echo $allinput['vendor_number'];} ?>" required>
			  		<div class="help-block with-errors">Vendor number</div>
			  	</div>
		  	</div>
		  	<!--Set tester under any agency or not-->
		  	<div class="form-group">
		  		<label for="inputPhone" class="col-sm-6 control-label">Want to create the tester under agency? </label>
		  		<div class="col-sm-4">
            ...
            <div class="form-group" style="display: none" id="tasters_rate_div">
		  		...
		  		<div class="col-sm-7">
			  		<input type="number" name="meta[tasters_rate]"  min="1" class="form-control" id="tasters_rate" placeholder="Enter tasters rate" value="" >
