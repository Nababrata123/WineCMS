      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          <div class="col-md-12" style="padding:10px 0;">
            ...
            <div class="col-sm-3"><?php if(isset($metadata['address'])){echo $metadata['address'];}else{echo "Not Available";}?></div>
          </div>
        </div>
        <div class="form-group">
          <div class="col-md-12" style="padding:10px 0;">
            <label class="col-sm-3 control-label">Phone no:</label>
            <div class="col-sm-3"><?php if(isset($metadata['phone'])){echo $metadata['phone'];}else{echo "null";}?></div>
          
            <label class="col-sm-3 control-label">Rate per hour:</label>
            <div class="col-sm-3"><?php if(isset($metadata['rate_per_hour'])){echo $metadata['rate_per_hour'];}else{echo "null";}?></div>
          </div>
        </div>
        <div class="form-group">
          <div class="col-md-12" style="padding:10px 0;">
