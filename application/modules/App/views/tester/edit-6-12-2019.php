	...
	<div class="container-fluid">
        ...
        <div id="sub-menu" class="pull-right">
        	<ul class="nav nav-pills">
        		<li><a href="<?php echo base_url('App/tester');?>"><span class="glyphicon glyphicon-sales_representative"></span>Taster</a></li>
    	...
    	<div class="col-sm-6">
      	...
      	<fieldset>
    		...
    		<div class="form-group">
		  		<label for="inputFirstName" class="col-sm-3 control-label">The tester is created by:</label>
	...
	<div class="col-sm-6">
		<fieldset>
            ...
            <div class="form-group">
		  		...
		  		<div class="col-sm-7">
			  		<input type="text" name="meta[zipcode]"  class="form-control" id="zipcode" placeholder="Enter zipcode" value="<?php if(isset($user_meta['city'])){echo $user_meta['zipcode'];}?>">
