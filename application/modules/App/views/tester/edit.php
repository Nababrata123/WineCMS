...
<div class="container-fluid main">
	...
	<?php
		...
		if($this->session->userdata('editInputData'))
		{
			$allinput=$this->session->userdata('editInputData');
      	...
      	<fieldset>
			...
			<div class="form-group">
		  	...
		  	<div class="form-group">
		  		...
		  		<div class="col-sm-7">
					<?php if(isset($allinput['email'])){?>
						<input type="email" name="email" class="form-control" id="inputEmail" placeholder="Enter email address" value="<?php echo $allinput['email'];?>" autocomplete="off">
						<?php }else{?>
			  		<input type="email" name="email" class="form-control" id="inputEmail" placeholder="Enter email address" value="<?php if($tester->is_empty_email != 1){ echo $tester->email; } ?>" autocomplete="off">
					<?php }?>
			  		<div class="help-block with-errors"></div>
			  	</div>
		  	</div>
			  ...
			  <div class="form-group">
		  		...
		  		<div class="col-sm-7">
			  		<input type="password" name="password" data-minlength="3"  class="form-control" id="inputPassword" placeholder="Enter password" value="<?php if($tester->is_empty_email != 1){ echo "Aaaa@000"; } ?>" autocomplete="new-password">

					<!-- <input class="form-control" type="password" id="inputPassword" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" placeholder="Enter password" value="<?php if($tester->is_empty_email != 1){ echo "Aaaa@000"; } ?>"> -->
		  	...
		  	<div class="form-group">
		  		...
		  		<div class="col-sm-7">
		  			<input type="password" name="c_password" class="form-control" id="inputConfirmPassword" data-match="#inputPassword" data-match-error="Whoops, these don't match" placeholder="Confirm password" autocomplete="new-password" value="<?php if($tester->is_empty_email != 1){ echo "Aaaa@000"; } ?>" >
		  			<div class="help-block with-errors"></div>
		  		</div>
		  	</div>
