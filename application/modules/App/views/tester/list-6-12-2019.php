	            ...
	            <tr>
                    ...
                    <td>
                        <?php
                            ...
                            {
                                $name=get_username('agency',$created_by);
	            	...
	            	<td>
	            		...
	            		<a class="btn btn-primary btn-xs" href="<?php echo base_url('App/tester/edit/'.$item->id);?>" title="Edit">
	            			<span class="glyphicon glyphicon-edit"></span> Edit
	            		</a>
	            		<!--<a class="btn btn-danger btn-xs <?php echo ($item->id == $this->session->userdata('id'))?'disabled':'';?>" href="<?php echo base_url('App/tester/delete/'.$item->id);?>" onclick="return confirm('Are you sure you want to delete this user account?');" title="Delete">
