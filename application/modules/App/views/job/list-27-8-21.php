    ...
    <table class="table table-striped table-responsive" width="100%">
            ...
            <?php 
                ...
                <?php if($filters['status'] == "problems")
                    ...
                    <?php  }else if($item->job_state == '0' && $item->endtime_state == '0'){ ?> 
                        <span class="label label-primary">Accepted</span>
                    <?php }else{?> 
                        <span style="padding: 5px;" class="label label-danger">Not Submited</span>
                    <?php }}?>
            </td>
                ...
                <td>
                    ...
                    <div id="<?php echo $item->id;?>" class="hide">
                        ...
                        <?php 
                            if( $item->is_archived!=1 &&  $filters['status'] == "problems" && $item->job_state == 1){ ?>
                                ...
                                <?php if( $filters['status'] == "problems" && $item->job_state != '0'){ ?>
                    ...
                    <?php }else if( $item->is_out_of_range == 1 || $item->is_out_of_range == 2){?>
                      ...
                      <?php } ?>
                       <?php } else{ ?>
                          <?php if($filters['status'] == "problems" && $item->ready_for_billing == 0 && $item->endtime_state != 1){?>
