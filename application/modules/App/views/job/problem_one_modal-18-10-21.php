    ...
    <div class="modal-content" id='modal'>
     ...
     <?php
      ...
      $attributes = array('class' => 'form-horizontal', 'id' => '', 'role' => 'form', 'data-toggle' => 'validator');
        echo form_open_multipart(base_url('App/job/create_billing_one/'.$job_id), $attributes);
     ?>
...
//  echo $start_minute;die;
 ...
 <div class="col-md-3">
 <label for="fname"><?php echo $start_hour; ?> : <?php echo $start_minute; ?> <?php if(date('A', strtotime($job_details->start_time))=='AM'){ echo "am";}else{ echo "pm";}?></label>
 </div>

 <label class="col-sm-3 control-label" style="margin-bottom:15px; padding-top:0px;">Scheduled end time:</label>
 <div class="col-md-3">

 <label for="fname"><?php echo $end_hour; ?> : <?php echo $end_minute; ?> <?php if(date('A', strtotime($job_details->end_time))=='AM'){ echo "am";}else{ echo "pm";}?></label>
 ...
 <option value="pm" <?php if(date('A', strtotime($job_details->finish_time))=='PM'){echo "selected";}?>>pm</option>
          ...
          foreach( $expense_details[0]['support_imgs']  as $imgindx){?>
            ...
            <?php echo '<div class="col-sm-2"><img data-enlargeable style="cursor: zoom-in; height: 120px; width: 100px;" src="'.BASE_URL.DIR_EXPENSE_IMAGE.$imgindx.'"> </div>'; ?>
        ...
        <div class="form-group">
          ...
          <center><legend>Manager verification details</legend></center>
            ...
            <div class="col-sm-8">
              <input type="text" name="name" class="form-control" value="<?php if(isset($manager_verification_details[0]['first_name'])){echo $manager_verification_details[0]['first_name']." ".$manager_verification_details[0]['last_name'];}?>">
              <div class="help-block with-errors"></div>
            </div>
          </div>
          <div class="col-md-12">
        ...
        <div class="form-group">
          ...
          <div class="col-md-12">
            ...
            <div class="col-sm-8">
              <textarea name="admin_note" rows="4" cols="30"  class="form-control"><?php if(isset($admin_note)){echo $admin_note;}?></textarea>
              <div class="help-block with-errors"></div>
            </div>
          </div>
          </fieldset>
        ...
        <div class="form-group">
          ...
          <div class="col-md-12">
            ...
            <div class="col-sm-8">
              <textarea name="general_note" rows="4" cols="30" class="form-control"><?php if(isset($general_note)){echo $general_note;}?></textarea>
              <div class="help-block with-errors"></div>
            </div>
          </div>
          </fieldset>
      ...
      <div class="modal-footer" style="text-align: center;">
        ...
        <button type="submit" class="btn btn-primary"  onclick="return validate();"><span class="glyphicon glyphicon-ok-sign"></span>Save & Move to billing</button> or <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
...
function validate(){ 
  var a = confirm('Do you wish to Save and Move to billing?');
  if(a==true){
   ...
   var  winevals= $("select[name=\'wine[]\']").map(function() {
    ...
    // else if(min < 30 && min >=0){
      ...
      if(time_one == 'pm' && time_two == 'am' && end_time > '03:00:00'){
        $('#end_time_hour').focus();
        swal("Oops!", "The end time cannot be greater than 3 a.m.", "warning");
        return false;
      }
    }else if(end_hour == '0'){
     if(time_one == 'pm' && time_two == 'am' && end_time > '3:00:00'){
        $('#end_time_hour').focus();
        swal("Oops!", "The end time cannot be greater than 3 a.m.", "warning");
        return false;
     }
