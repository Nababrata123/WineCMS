	...
	<div class="col-sm-6">
      	<fieldset>
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					<select name="start_time_hour" class="form-control" id="start_time_hour">
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					<select name="end_time_hour" class="form-control" id="end_time_hour">
						<option value="">Hour</option>
						<?php
						for($i=1;$i<=12;$i++){
							if($i<10){
            ...
            <input type="hidden" id="hidden_store_id" value="">
		  	...
		  	<div class="form-group">
				  ...
				  <button type="submit" class="btn btn-primary oc"><span class="glyphicon glyphicon-ok-sign"></span>Clone</button> or <a href="#" onclick="goBack()">Cancel</a>
			  	</div>
		  	</div>
	  	</fieldset>
	</div>
	<div class="col-sm-6">
		<fieldset>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<select class="chosen-select form-control" id="wines" name="wine_id[]" multiple="multiple" data-placeholder="Select wine(s)">
						<?php
			  				foreach($wine as $value){
			  			?>
