            ...
            <?php 
                ...
                <td>
                    ...
                    <div id="<?php echo $item->id;?>" class="hide">
                        ...
                        <?php if($item->job_state==1){?>
                            <a class="btn btn-primary btn-xs" href="javascript:void(0)" title="Edit"  onclick="job_start_edit_modal(<?php echo $item->id;?>)" style="margin-top:3px; margin-bottom: 2px; width: 75px;"> <span class="glyphicon glyphicon-edit"></span> Edit</a>
                        <?php }else{?>
                        ...
                        <?php 
                            if( $item->is_archived!=1 &&  $filters['status'] == "problems" && $item->job_state == 1){ ?>
                                ...
                                <a class="btn btn-primary btn-xs" href="javascript:void(0)" title="Edit dh"  onclick="alert('The taster is setting up the tasting now, please wait until they start the job in order to edit the job end time')" style="margin-top:2px; width: 75px;"> <span class="glyphicon glyphicon-edit"></span> Edit</a>
                        		<?php } else if($item->endtime_state==2 || $item->endtime_state==4 || $item->endtime_state==0){?> 
                            	<a class="btn btn-primary btn-xs" href="javascript:void(0)" title="Edit"  onclick="edit_modal(<?php echo $item->id;?>)" style="margin-top:2px; width: 75px;"> <span class="glyphicon glyphicon-edit"></span> Edit</a>
...
<script type="text/javascript">
    ...
    function job_start_edit_modal(job_id)
    {
    	//alert(job_id);
    	$.ajax({
		   type:'POST',
