...
<?php
        ...
        echo form_open(base_url('App/Bulk_schedule_job/search_submit'), $attributes);
	...
	<div class="table-responsive">
		<div class="tasting-date-search-container">
            <div class="form-group">
                <label for="inputName">Tasting date: </label>
            ...
            <div class="form-group" style="padding-left: 100px;">
                ...
                <button type="button" class="btn btn-default" onclick="window.location='<?php echo base_url('App/bulk_schedule_job');?>'"><span class="glyphicon glyphicon-refresh"></span> Reset</button>
            </div>
        </div>
	    ...
	    <table class="table table-striped table-responsive" width="100%" id="user-table">
	        ...
	        <tbody>
				...
				?>
					...
					<td><?php if($item->schedule_type!=''){if($item->schedule_type=='biweekly'){echo "Bi-weekly";}else{echo ucfirst($item->schedule_type);}}else{echo "--";}?></td>
			...
			<tfoot>
                ...
                <?php if(count($jobs) != 0){ ?>
                    <td colspan="8">
                        With selected
                        <button id="delete" name="operation" value="delete" class="btn btn-sm btn-danger" ><span class="glyphicon glyphicon-trash"></span> Delete</button>
                    </td>
                    <?php }?>
                </tr>
            </tfoot>
    ...
    e.preventDefault();
            if(confirm("Are you sure you want to delete the Job(s)?")){
                ...
                if(id.length === 0) {
                    ...
                    $.ajax({
                        url:"<?php echo base_url();?>App/Bulk_schedule_job/multiple_delete/",
                        method:'POST',
                        data:{item_id:id},
                        success:function(data){ 
