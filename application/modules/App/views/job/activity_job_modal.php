...
<div class="modal-content">
      ...
      <div class="modal-body">
		...
		$rejected_users;
          ...
          foreach($accepted_user as $au)
          {
            ...
            else
            {
                ...
                $accepted.=$au['last_name']." ".$au['first_name'].",";
        ...
        <table id="classTable" class="table table-bordered">
            ...
            <tr>
                <td>
                    <strong>Canceled by:&nbsp;</strong><?php if(isset($cancelled_job_details[0]['taster_name'])){echo $cancelled_job_details[0]['taster_name'];}else{echo "None";}?>
                    <br>
				...
				<td><strong>Rejected by:&nbsp;</strong>
				<?php if($job_status=='rejected'){echo $rej_user;}else{echo "None";}?>
				</td>
            </tr>
