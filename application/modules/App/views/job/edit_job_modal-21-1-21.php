     ...
     <div class="col-sm-12">
      <fieldset>
        ...
        <div class="form-group">
          ...
          <button type="submit" class="btn btn-primary" onclick="return validate();"><span class="glyphicon glyphicon-ok-sign"></span>Save</button> or <a type="button" class="btn btn-default" data-dismiss="modal" >Cancel</a>
