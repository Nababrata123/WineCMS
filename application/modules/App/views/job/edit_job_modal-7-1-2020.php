      ...
      <fieldset>
        ...
        <div class="form-group">
          <div class="col-sm-offset-3 col-sm-6">
            <button type="submit" class="btn btn-primary" onclick="return confirm('Do you wish to edit the job?');"><span class="glyphicon glyphicon-ok-sign"></span>Save</button> or <a href="<?php echo base_url('App/Job/index/status/accepted');?>">Cancel</a>
          </div>
        </div>
      </fieldset>
