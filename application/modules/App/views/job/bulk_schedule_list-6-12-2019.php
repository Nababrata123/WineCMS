<div class="subnav">
	<div class="container-fluid">
    	<h1><span class="glyphicon glyphicon-user"></span> Bulk Schedule Management</h1>
        <div id="sub-menu" class="pull-right">
        	<ul class="nav nav-pills">
        		<li class="active"><a href="<?php echo base_url('App/Bulk_schedule_job');?>"><span class="glyphicon glyphicon-user"></span> Bulk Schedule</a></li>
