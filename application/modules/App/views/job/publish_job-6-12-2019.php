...
<div class="subnav">
	<div class="container-fluid">
    	<h1><span class="glyphicon glyphicon-store"></span> Publish job &raquo; <small></small></h1>
        <div id="sub-menu" class="pull-right">
        	<ul class="nav nav-pills">
        		<li><a href="<?php echo base_url('App/job');?>"><span class="glyphicon glyphicon-store"></span> Job</a></li>
            ...
            <input type="hidden" id="hidden_store_id" value="">
		  	...
		  	<div class="form-group">
		  		<div class="col-sm-offset-3 col-sm-6">
			  		<button type="submit" class="btn btn-primary" onclick="return confirm('Are you ready to confirm the job?');"><span class="glyphicon glyphicon-ok-sign"></span>Publish</button> or <a href="<?php echo base_url('App/job');?>">Cancel</a>
			  	</div>
		  	</div>
	  	</fieldset>
	</div>
