     ...
     <div class="col-sm-12">
      <fieldset>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-7"> 
          <input id="exp_amount" name="exp_amount" value="<?php echo $expence_amount->exp_amount;?>" class="form-control">
            <div class="help-block with-errors"></div>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-7"> 
          <textarea placeholder="Expance Reason" id="exp_reason" name="exp_reason" class="form-control"><?php echo $expence_amount->exp_reason;?> </textarea>
            <div class="help-block with-errors"></div>
          </div>
        </div>
...
$(document).ready(function() {
    ...
    <?php
      ...
      foreach($wineList as $w){
        $wine.='<option value="'.$w['id'].'">'.$w['name'].'</option>';
      }
    ?>
