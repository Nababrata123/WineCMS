...
<div class="subnav">
	<div class="container-fluid">
    	<h1><span class="glyphicon glyphicon-user"></span> Edit Bulk Schedule &raquo; <small></small></h1>
	...
	<div class="col-sm-6">
		<fieldset>
    		...
    		<div class="form-group">
		  		...
		  		<div class="col-sm-7">
			  		<select name="taster_id[]"  required class="form-control" multiple="multiple" id="testers">
			  			<?php
...
checkboxes.on('change', function() {
    ...
    $.ajax({
		   type:'POST',
		   url:"<?php echo base_url(); ?>App/Bulk_schedule_job/set_wine_id/",
...
$("#sw").keyup(function () {
    ...
    $.ajax({
		   type:'POST',
		   url:"<?php echo base_url(); ?>App/Bulk_schedule_job/get_wine_using_search_key/",
