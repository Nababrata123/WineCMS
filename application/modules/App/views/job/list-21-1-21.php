                ...
                <div class="col-md-4" >
                    ...
                    <div class="col-md-3">
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <label for="inputName" style="margin-top: 10px;">Status Filter</label><br />
                ...
                <?php }else{ ?> 
                    ...
                    <div class="col-md-3">
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <label for="inputName" style="margin-top: 10px;">Sort by date</label><br />
    ...
    <table class="table table-striped table-responsive" width="100%">
            ...
            <?php 
                ...
                <td>
                    ...
                    <div id="<?php echo $item->id;?>" class="hide">
                        ...
                        <?php $date_now = date("Y-m-d"); ?>
                        <?php if ($item->endtime_state==1 && $date_now > $item->tasting_date) { ?>
                            <a class="btn btn-danger btn-xs" href="javascript:void(0)" title="Delete" style="margin-top:2px" onclick="deleteJob(<?php echo $item->id; ?>)"> <span class="glyphicon glyphicon-trash"></span> Delete</a>
                            <?php } ?>
                            ...
                            <?php if($date_now > $item->tasting_date){?>
                                ...
                                <?php if($item->endtime_state==1 || $item->endtime_state==2 || $item->endtime_state==4){ ?>
                                    <a class="btn btn-primary btn-xs" href="javascript:void(0)" title="Edit"  onclick="edit_modal(<?php echo $item->id;?>)" style="margin-top:2px; margin-bottom: 2px;"> <span class="glyphicon glyphicon-edit"></span>Edit</a>

                                    <?php }else {?>
                                        <a class="btn btn-primary btn-xs" href="javascript:void(0)" title="Edit"  onclick="alert('The taster is setting up the tasting now, please wait until they start the job in order to edit the job end time')" style="margin-top:2px; margin-bottom: 2px;"> <span class="glyphicon glyphicon-edit"></span>Edit</a>
                                <?php } }
                        ...
                        <?php 
                            if( $item->is_archived!=1 &&  $filters['status'] == "problems" && $item->job_state == 1){ ?>
                            	...
                            	<a class="btn btn-primary btn-xs disabled" title="Edit" style="margin-top:2px; margin-bottom: 2px;"> <span class="glyphicon glyphicon-edit"></span>Edit</a> 
                        		<?php } ?>
                                <?php } }?>
                            ...
                            if ($filters['status'] != "problems" && $item->job_state == 2 ){ ?>
                                ...
                                <a class="btn btn-danger btn-xs delete_button" href="javascript:void(0)" title="Delete" onclick=" completed_job_details_view_modal(<?php echo $item->id; ?>);">
                                    <span class="glyphicon glyphicon-list-alt"></span> View Details
                                </a>

                                <a class="btn btn-success btn-xs" style="margin-top:2px; margin-bottom: 2px;" target="_blank" href="<?php echo base_url();?>App/billing/download_invoice/<?php echo $item->id;?>" title="View"><span class="glyphicon glyphicon-download"></span> View Invoice</a>
			...
			<tfoot>
                <tr>
                    ...
                    <td colspan="8">
                        With selected
                        <button type="submit" id="dltBtn" name="operation" value="delete" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete the job(s)?')"><span class="glyphicon glyphicon-trash"></span> Delete</button>
                    </td>
                    <?php }
                 ?>
                </tr>
