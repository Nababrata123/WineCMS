<!-- Modal content-->
    ...
    <div class="modal-content">
     ...
     <div class="col-sm-12">
        <fieldset>
          ...
          <div class="form-group">
            ...
            <textarea readonly name="Comments" class="form-control" id="Comments"  placeholder="Feedback"  ><?php if(isset($general_note)){echo $general_note;}   ?></textarea>
                        <!-- <textarea name="Comments" class="form-control" id="Comments"  placeholder="Feedback"  ><?php if ($manager_verification_details[0]['comment']!= null ) { echo $manager_verification_details[0]['comment'];?> <?php } ?></textarea> -->
              <div class="help-block with-errors"></div>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-7"> 
            <input readonly id="exp_amount" onkeypress="return isNumberKey(event,this)" name="exp_amount" value="<?php if(isset($expense_details[0]['exp_amount'])){echo ltrim($expense_details[0]['exp_amount'],'$');}?>" class="form-control">
              <div class="help-block with-errors"></div>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-7"> 
            <textarea readonly placeholder="Expense Reason" id="exp_reason" name="exp_reason" class="form-control"><?php if(isset($expense_details[0]['exp_reason'])){echo ltrim($expense_details[0]['exp_reason'],"$");}?></textarea>
              <div class="help-block with-errors"></div>
            </div>
          </div>
      ...
      <div class="col-md-12">
          <label for="inputExpAmount" class="col-sm-3 control-label">Receipt Image:</label>
          <?php 
          if(count($expense_details[0]['support_imgs'])>0){
          }else{ echo ' <label for="inputExpAmount" class="col-sm-3 control-label"> No images available</label>';} ?>
          </div>
          <div class="col-md-12"> 
          ...
          foreach( $expense_details[0]['support_imgs']  as $imgindx){?>
            ...
            <?php echo '<div class="col-sm-4"><img data-enlargeable style="cursor: zoom-in" src="'.BASE_URL.DIR_EXPENSE_IMAGE.$imgindx.'"> </div>'; ?>
          ...
          <div class="form-group">
          <div class="col-md-12">
            <label class="col-sm-2 control-label">Testing Setup images:</label>
      ...
      <fieldset >
        ...
        <?php }?>
          ...
          <div class="form-group">
             ...
             <div class="col-sm-7"> 
              <input readonly id="exp_amount" onkeypress="return isNumberKey(event,this)" name="exp_amount" value="<?php echo $start_hour; ?>" class="form-control">
              <div class="help-block with-errors"></div>
            </div>
          </div>
