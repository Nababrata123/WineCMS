<!-- Modal content-->
 ...
 <option value="pm" <?php if(date('A', strtotime($job_details->finish_time))=='PM'){echo "selected";}?>>pm</option>
      ...
      <div class="modal-footer">
        ...
        <!-- <input type="submit" class="btn btn-primary" value="Save & Move to billing" value="click" id="save_and_move">
...
$("save_and_move").submit(function(e){
            ...
            if(!$("#submit_button").hasClass("disabled"))
            {
                ...
                // {
                    ...
                    if(time_one == 'pm' && time_two == 'am' && end_hour >=3){
...
function validate(){ 
  var a = confirm('Do you wish to move to billing?');
  if(a==true){
   // alert($('#wine').val());
