...
<div class="subnav">
	<div class="container-fluid">
    	<h1><span class="glyphicon glyphicon-store"></span> Add job &raquo; <small></small></h1>
...
{ echo $allinput['user_id'];}?>">
		  		<div class="col-sm-7">
			  		<select name="user_id"  required class="form-control" onchange="get_store(this.value)">
			  			...
			  			<option value="<?php echo $value['id'];?>" <?php if($value['id']==$allinput['user_id']){echo "selected";}?>><?php echo $value['first_name']." ".$value['last_name'];?></option>
			  			<?php
			  				}
			  				else
			  				{
