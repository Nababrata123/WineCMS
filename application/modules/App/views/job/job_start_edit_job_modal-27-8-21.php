     ...
     <div class="col-sm-12">
      <fieldset>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-7">
          <?php if(($job->status=='approved' || $job->status=='problems') && $job->job_state==1){ ?>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-3">
          <input id='currentJobState' type="hidden" value="<?php echo $job->job_state ?>" class="form-control">
        ...
        <div class="form-group">
          ...
          <?php if(($job->status=='approved' || $job->status=='problems') && $job->job_state==1){ ?>
            ...
            <?php }else{?> 
              ...
              <select name="taster_id"  class="form-control" >
                <option value="">Select Taster</option>
              <?php
      ...
      <fieldset id="wineForm">
        ...
        <div class="col-sm-2">
        <button class="add_field_button" href="#" disabled><span class="glyphicon glyphicon-plus-sign"></span>Add more </button>
        </div>
      </fieldset>
      <fieldset >
      ...
      <div class="input_fields_wrap">
        <?php 
         foreach($get_wine_info as $value){?> 
              ...
              <div class="row">
                <div class="col-sm-4">
                <select class="form-control disabled" id="wine" name="wine[]">
                ...
                <div class="col-sm-2">
                  <input name="bottles_sampled[]" value="<?php echo $value['bottles_sampled']; ?>" onkeypress="return onlyNumberKey(event)" class="form-control" readonly> 
                </div>
                <div class="col-sm-2">
                  <input name="open_bottles_sampled[]" value="<?php echo $value['open_bottles_sampled']; ?>" onkeypress="return onlyNumberKey(event)" class="form-control" readonly> 
                </div>
                <div class="col-sm-2">
                  <input name="bottles_sold[]" value="<?php echo $value['bottles_sold']; ?>" onkeypress="return onlyNumberKey(event)" class="form-control" readonly> 
                </div>
                <a href="#" class="remove_field disabled"><strong><span class="glyphicon glyphicon-minus-sign" style="padding-top: 10px;"></strong></a>
              </div>
...
function validate(){
    ...
    else if(time1.getTime()<curtime.getTime() && $('#currentJobState').val()!=1)
    {
			$('#start_time_hour').focus();
			swal("Oops!", "Start time should be greater than current time.", "warning");
			return false;
    }
   /* else if(time2.getTime()<curtime.getTime()){
			$('#end_time_hour').focus();
			swal("Oops!", "End time should be greater than current time.", "warning");
			return false;
		}*/
...
$(document).ready(function() {
    ...
    //  alert(wine);
    var html ='<div class="row" style="margin-top:20px;"><div class="col-sm-4"><select class="form-control" id="wine" name="wine[]">'+wine+'</select></div><div class="col-sm-2"><input value="0" name="bottles_sampled[]" onkeypress="return onlyNumberKey(event)" class="form-control" readonly></div> <div class="col-sm-2"><input value="0" onkeypress="return onlyNumberKey(event)" name="open_bottles_sampled[]" class="form-control" readonly></div> <div class="col-sm-2"><input value="0" onkeypress="return onlyNumberKey(event)" name="bottles_sold[]" class="form-control" readonly> </div> <a href="#" class="remove_field"><strong><span class="glyphicon glyphicon-minus-sign" style="padding-top: 10px;"></strong></a></div>';
		e.preventDefault();      
