<!-- Modal content-->
    ...
    <div class="modal-content">
      <div class="modal-header bg-info">
        ...
        <h4 class="modal-title">Edit job C</h4>
      </div>
     <?php
     ...
     <div class="col-sm-12">
      <fieldset>
        ...
        <div class="form-group">
           ...
           // print_r($job);die;
            //echo $job->status;die;
                ...
                // $sE = date('A', strtotime($job->finish_time));
                // echo $start_hour.' '.$end_hour.' '.$start_minute.' '.$sE;die;
            ?>
        <div class="col-md-12">
            ...
            <div class="col-sm-3">
              ...
              <option value="am" <?php if(date('A', strtotime($job->job_start_time))=='AM'){echo "selected";}?>>am</option>
              <option value="pm" <?php if(date('A', strtotime($job->job_start_time))=='PM'){echo "selected";}?>>pm</option>
            </select>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-3">
            ...
            <select name="time_two" required class="form-control" id="time_two">
              <option value="am" <?php if(date('A', strtotime($job->finish_time))=='AM'){echo "selected";}?>>am</option>
              <option value="pm" <?php if(date('A', strtotime($job->finish_time))=='PM'){echo "selected";}?>>pm</option>
            </select>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-7"> 
          <textarea name="general_note" id="general_note" required class="form-control" placeholder="Feedback"><?php if(isset($general_note)){echo $general_note;}?></textarea>      
            <div class="help-block with-errors"></div>
          </div>
        </div>
