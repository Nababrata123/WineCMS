<div class="subnav">
	<div class="container-fluid">
    	<h1><span class="glyphicon glyphicon-user"></span> Archive Management</h1>
        <div id="sub-menu" class="pull-right">
        	<ul class="nav nav-pills">
        		<li class="active"><a href="<?php echo base_url('App/Archive');?>"><span class="glyphicon glyphicon-user"></span> Archive</a></li>
    		</ul>
        </div>
    </div>
</div>
	    ...
	    <table class="table table-striped table-responsive" width="100%">
	        ...
	        <tbody>
	            ...
	            <tr>
	            	...
	            	<td><?php echo $item->taster_name;?></td>
