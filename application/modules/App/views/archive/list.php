			...
			<tfoot>
                ...
                <?php if(count($jobs) != 0){ ?>
                    <td colspan="8">
						...
						<button  value="move_to_billing" class="btn btn-warning" id="move_to_billing">Move to billing</button>
                    </td>
                    <?php }?>
                </tr>
            </tfoot>
...
<script type="text/javascript">
	...
	$('#submitBtn').click();
		...
		swal({
			...
			confirmButtonText: "Yes, Move to billing!",
	...
	$("#move_to_billing").click(function(e){
        e.preventDefault();
