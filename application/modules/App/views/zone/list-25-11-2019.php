<div class="subnav">
	<div class="container-fluid">
    	<h1><span class="glyphicon glyphicon-marker"></span> Zone Management</h1>

        <div id="sub-menu" class="pull-right">
        	<ul class="nav nav-pills">
        		<li class="active"><a href="<?php echo base_url('App/zone');?>"><span class="glyphicon glyphicon-marker"></span> Zone</a></li>
