<div class="subnav">
	<div class="container-fluid">
    	<h1><span class="glyphicon glyphicon-map-marker"></span> Zone Management</h1>

        <div id="sub-menu" class="pull-right">
        	<ul class="nav nav-pills">
        		<li class="active"><a href="<?php echo base_url('App/zone');?>"><span class="glyphicon glyphicon-map-marker"></span> Zone</a></li>
...
<div class="container-fluid main">
	...
	?>
	<a href="<?php echo base_url('App/zone/refresh');?>"  class="btn btn-info">
