<div class="subnav">
	<div class="container-fluid">
    	<h1><span class="glyphicon glyphicon-map-marker"></span> Edit Zone &raquo; <small> <?php echo $zone->name;?></small></h1>
        <div id="sub-menu" class="pull-right">
        	<ul class="nav nav-pills">
        		<li><a href="<?php echo base_url('App/zone');?>"><span class="glyphicon glyphicon-map-marker"></span>Zone</a></li>
