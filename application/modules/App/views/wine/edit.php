	...
	<div class="col-sm-6">
      	...
      	<fieldset>
			...
			<div class="form-group">
				...
				<div class="col-sm-7">
					<input type="file" name="pics[]" class="form-control" accept="image/jpeg, image/png" id="inputPic" placeholder="Upload an Image" multiple>
			...
			<div class="form-group">
		  	...
		  	<div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" name="size" class="form-control" id="size" placeholder="Enter size" value="<?php echo (double)$wine->size; ?>" required>
                  ...
                  <div class="col-sm-2" >
                    ...
                    ?>
                      <option value="<?php echo $value;?>" <?php if($wine->UOM==$value){echo "selected";}?>><?php echo $value;?></option>
                    <?php } ?>
		  	...
		  	?>
		  		...
		  		<div class="col-sm-7">
			  		...
			  		<div class="radio">
					  <label for="royal">
					    <input type="radio" name="flavour" id="royal" value="royal" <?php if(in_array('royal',$flavour_array)){echo 'checked';}?>>
					    Royal
					  </label>
					</div>
					<div class="radio">
					  <label for="mix">
					  <input type="radio" name="flavour" id="mix" value="mix" <?php if(in_array('mix',$flavour_array)){echo 'checked';}?>>
					  MYX
					  </label>
					</div>
					<div class="radio">
					  <label for="kayco">
					  <input type="radio" name="flavour" id="kayco" value="kayco" <?php if(in_array('kayco',$flavour_array)){echo 'checked';}?>>
					  Kayco
					  </label>
					</div>
					<div class="radio">
					  <label for="other">
					  <input type="radio" name="flavour" id="other" value="other" <?php if(in_array('other',$flavour_array)){echo 'checked';}?>>
					  Other
					  </label>
					</div>
