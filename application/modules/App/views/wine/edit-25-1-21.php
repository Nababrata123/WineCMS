                ...
                <div class="input-group">
                  ...
                  <div class="col-sm-2" >
                        <select id="uomDropdown" name="uom" required class="form-control">
                            <option value="ML" <?php if($wine->UOM=="ML"){echo "selected";}?> >ML</option>
                            <option value="L" <?php if($wine->UOM=="L"){echo "selected";}?> >L</option>
                            
                            <option value="GAL" <?php if($wine->UOM=="GAL"){echo "selected";}?> >GAL</option>
                            <option value="OZ" <?php if($wine->UOM=="OZ"){echo "selected";}?> >OZ</option>
                            </select>
                    </div>
            </div>
		  	<?php
