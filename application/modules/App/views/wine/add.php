      	...
      	<fieldset>
			...
			<div class="form-group">
				...
				<div class="col-sm-7">
					...
					<div class="help-block"><h5>Note :- File size can be up to 8 MB.</h5></div>
				</div>
			</div>
	  	</fieldset>
	</div>
		...
		<fieldset>
		  	...
		  	<div class="form-group">
                ...
                <div class="col-sm-4">
                  ...
                  <div class="col-sm-2" >
                    ...
                    ?>
                      <option value="<?php echo $value;?>" <?php if($value == 'ML'){echo "selected";}?>><?php echo $value;?></option>
                    <?php } ?>
			...
			<div class="form-group">
		  		...
		  		<div class="col-sm-8">
					  ...
					  <input type="radio" name="flavour" value="royal" checked required>
					    Royal
					  </label>
					  </div>
					  <div class="radio">
					  <label for="checkboxActive">
					  <input type="radio" name="flavour" value="mix">
					    MYX
					  </label>
					</div>
					<div class="radio">
					  <label for="checkboxActive">
					  <input type="radio" name="flavour" value="kayco">
					  Kayco
					  </label>
					</div>
					<div class="radio">
					  <label for="checkboxActive">
					  <input type="radio" name="flavour" value="other">
					  Other
					  </label>
					</div>
			  		<div class="help-block with-errors"></div>
...
var file_size = $('#inputPic')[0].files[0].size;
if(file_size > 8000000) {
	alert("Sorry, could not upload the image. Images cannot be greater than 8 MB.");
	return false;
}
return true;
});
