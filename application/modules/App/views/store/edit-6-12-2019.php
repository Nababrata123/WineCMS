<div class="subnav">
	<div class="container-fluid">
    	<h1><span class="glyphicon glyphicon-store"></span> Edit store &raquo; <small> <?php echo $store->name;?></small></h1>
        <div id="sub-menu" class="pull-right">
        	<ul class="nav nav-pills">
        		<li><a href="<?php echo base_url('App/store');?>"><span class="glyphicon glyphicon-store"></span> Store</a></li>
	...
	<div class="col-sm-6">
		<fieldset>
    		...
    		<div class="form-group">
		  		...
		  		<div class="col-sm-7">
			  		<input type="text" name="phone" data-minlength="10" maxlength="10" class="form-control" id="phone" placeholder="Enter phone number" value="<?php echo $store->phone; ?>">
    		...
    		<div class="form-group">
		  		...
		  		<div class="col-sm-7">
			  		<input type="text" name="store_manager"  class="form-control" id="store_manager" placeholder="Enter store manager" value="<?php echo $store->store_manager; ?>">
			  		<div class="help-block with-errors"></div>
    		 ...
    		 <div class="form-group">
		  		...
		  		<div class="col-sm-7">
			  			...
			  			<select class="chosen-select form-control" name="sales_rep[]" multiple="multiple" data-placeholder="Sales representative..." required>
			  				...
			  				foreach($sales_rep as $value){
			  				?>
						  <option value="<?php echo $value->id;?>"<?php if(in_array($value->id, $sales_rep_array)){echo "selected";}?>><?php echo $value->first_name." ".$value->last_name;?></option>
						   <?php } ?>
						</select>
			  			<div class="help-block with-errors"></div>
