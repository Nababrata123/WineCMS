	...
	<div class="col-sm-6">
		<fieldset>
    		...
    		<div class="form-group">
			  ...
			  <div class="form-group">
                <label for="inputPhone" class="col-sm-3 control-label">Store Email*</label>
                <div class="col-sm-7">
                    <input type="text" name="email_address" class="form-control" id="email_address" placeholder="Enter store manager email" value="<?php echo set_value('store_manager'); ?>" required>
                    <div class="help-block with-errors"></div>
