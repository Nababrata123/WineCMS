	...
	<div class="col-sm-6">
		<fieldset>
    		...
    		<div class="form-group">
		  		...
		  		<div class="col-sm-7">
			  		<input type="text" name="store_manager"  class="form-control" id="store_manager" placeholder="Enter store manager name" value="<?php echo set_value('store_manager'); ?>">
			  		<div class="help-block with-errors"></div>
			...
			<div class="form-group">
                ...
                <div class="col-sm-7">
                    <input type="email" name="email_address"  class="form-control" id="inputEmail" placeholder="Enter store Email" value="<?php echo set_value('email'); ?>" autocomplete="off">
                    <div class="help-block with-errors"></div>
    		 ...
    		 <div class="form-group">
			  ...
			  <div class="form-group">
		  		...
		  		<div class="col-sm-7">
					...
					Kayco<input type="checkbox" name="wine_sell_type[]" value="kayco">
			  		Other<input type="checkbox" name="wine_sell_type[]" value="other">
			  		<div class="help-block with-errors"></div>
			  	</div>
		  	</div>
