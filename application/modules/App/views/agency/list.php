...
<div class="row"><div class="col-md-12"></div></div>
	...
	?>
	<a href="<?php echo base_url('App/agency/refresh');?>"  class="btn btn-info">
	    ...
	    <table class="table table-striped table-responsive" width="100%" id="user-table">
	        ...
	        <tbody>
	            ...
	            <tr>
					...
					<td><?php echo get_agency_name('user_meta',$item->id);?></td>
					...
					<td>
	            		<a class="btn btn-info btn-xs" href="javascript:void(0)" title="View" onclick="taster_under_agency(<?php echo $item->id;?>)">
	            			<span class="glyphicon glyphicon-eye-open"></span> View
	            		</a>
	            	</td>
	            	<td>
