<div class="subnav">
	<div class="container-fluid">
    	<h1><span class="glyphicon glyphicon-agency"></span> Edit Agency &raquo; <small> <?php echo $agency->first_name." ".$agency->last_name;?></small></h1>
        <div id="sub-menu" class="pull-right">
        	<ul class="nav nav-pills">
        		<li><a href="<?php echo base_url('App/agency');?>"><span class="glyphicon glyphicon-agency"></span> Agency</a></li>
	...
	<div class="col-sm-6">
      	...
      	<fieldset>
    		...
    		<div class="form-group">
		  		<label for="inputFirstName" class="col-sm-3 control-label">Testers under the agency:</label>
		  		<div class="col-sm-7">
		  			<?php
