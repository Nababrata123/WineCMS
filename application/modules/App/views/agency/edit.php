      	...
      	<fieldset>
			...
			<div class="form-group">
		  	...
		  	<div class="form-group">
		  		...
		  		<div class="col-sm-7">
			  		<input type="email" name="email" class="form-control" id="inputEmail" placeholder="Enter email address" value="<?php echo $agency->email; ?>" autocomplete="off">
			  		<div class="help-block with-errors"></div>
			  	</div>
		  	</div>
	...
	<div class="col-sm-6">
		<fieldset>
    		...
    		<div class="form-group">
		  		...
		  		<div class="col-sm-7">
			  		<input type="text" name="meta[phone]" data-minlength="10" maxlength="14" class="form-control nuf" id="phone" placeholder="Enter phone number" value="<?php echo $user_meta[1]['meta_value']; ?>">
    		...
    		<div class="form-group">
		  		...
		  		<div class="col-sm-7">
			  		<input type="text" name="meta[adress]"  class="form-control" id="home_adress" placeholder="Enter address" value="<?php echo $user_meta[2]['meta_value']; ?>" required autocomplete="off">
    		...
    		<!--div class="form-group">
		  	...
		  	<div class="form-group">
		  		...
		  		<div class="col-sm-7">
			  		<input type="text" name="meta[manual_account_number]"  maxlength="10" class="form-control" id="manual_account_number" placeholder="Enter account number" value="<?php if(array_key_exists(4,$user_meta)){echo $user_meta[4]['meta_value'];}else{echo '';} ?>" required autocomplete="off">
