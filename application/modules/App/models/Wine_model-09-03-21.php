...
class Wine_model extends CI_Model {
    ...
    public function search_wine($search_text,$wine_sell_type)
    {
        ...
        $this->db->select("wine.id as id,wine.name as name,wine.description,UPPER(wine.flavour)  as type,wine.company_type,wine.upc_code as upc,wine.brand,wine.year,wine.size as size,wine.category_id, UOM");
        $this->db->from('wine');
