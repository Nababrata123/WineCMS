...
/*        //Calculate total amount
    ...
    function get_brandwise_expense($brand, $from_date, $to_date, $taster, $agency, $store, $sales_rep, $wine_type, $size, $month, $brand_id_array)
    {
        ...
        for($i=0;$i<count($result);$i++)
        {
            ...
            if ($this->session->userdata('role')=='brand_wise_users'){
                $this->db->where_in('completed_job_wine_details.wine_id',$brand_id_array);
            }
