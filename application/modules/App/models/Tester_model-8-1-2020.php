...
class Tester_model extends CI_Model {
     ...
     */
        ...
        $this->column_order = array('first_name','last_name','email','status');
        // Set searchable column fields
        $this->column_search = array('first_name','last_name','email','status');
        // Set default order
            ...
            if($item!=''){
                ...
                if($i===0){
                    ...
                    if($item=='first_name' || $item=='last_name')
                        ...
                        $this->db->like('CONCAT(first_name, " " , last_name)', $term);
                    else
                        $this->db->like($item, $term);
                }else{
                    if($item=='first_name' || $item=='last_name')

                        $this->db->or_like('CONCAT(first_name, " ", last_name)', $term);
                    else
