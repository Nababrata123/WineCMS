            ...
            if ($this->form_validation->run())
            {
                ...
                if($taster_id != ''){
                    ...
                    if($taster == 'agency') {
                        ...
                        $job_status='2';
                        /*
                        if($data['job_info']->status=='assigned' || ($data['job_info']->status=='approved' && $data['job_info']->job_state < 1) || ($data['job_info']->status=='pending' && $data['job_info']->job_state < 1))
                        {
                            $status='assigned';
                            $job_status='2';
                        }else {
