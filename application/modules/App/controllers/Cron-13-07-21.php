                ...
                if(!$isInvalidKey) {
                    ...
                    if(!$duplicate){
                        foreach($csvData as $row){ 
                            ...
                            $successMsg = 'Wine imported successfully. Total Rows ('.count($csvData).') | Inserted ('.$insertCount.') | Updated ('.$updateCount.') | Not Inserted ('.$notAddCount.')';
    ...
    public function wine_ImageUpload_From_server(){
                ...
                foreach ($ImagesArray as $imageName){
                    ...
                    if (!empty($imageUPC)) {
                        ...
                        $productImage = 'wine-'.$imageName;

                        // Update database here
                        $this->Wine_model->save_product_image($wine_Id, $productImage);
