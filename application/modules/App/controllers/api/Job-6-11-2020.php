...
//Submit tasting setup
                    ...
                    if (!empty($supported_imgs['name'][0])) {
                            ...
                            foreach ($supported_imgs['name'] as $key => $image) {
                                ...
                                if ($this->upload->do_upload('images[]')) {
                                    ...
                                    $uploaded_pics = $upload_data['file_name'];
                                    // Update database here
                                    $image_id=$this->Job_model->insert_tasting_setup_images($insert_id, $uploaded_pics);
                                } else {
                                    $this->upload->display_errors(); die;
                                }
                            }
    ...
    public function jobRatingMailTemplate($job_id, $manager_name, $samplingDate, $tasterName, $startTime, $finish_time, $wineNames)
    {
       $data='';
       $data.='<!DOCTYPE html>
       <html lang="en">
                       ...
                       <table style="width:100%;">
                           <tr>
                               <td colspan="3" style="text-align:center;">
                                   <img class="logo" src="'.BASE_URL.'assets/wine/thumb/Wine_Logo.png">
                               </td>
                           </tr>
                           <tr>
                               <td colspan="3" style="text-align:center;">
                           ...
                           <tr>
                               <td colspan="3">
                                   <h3 style="margin-top:auto;">Wine Sold : </h3>
                               </td>
                           </tr>
                           <tr>
                               <td colspan="3">
                                ...
                                if (!empty($wineNames)) {
                                    ...
                                    $data.='<tr>
                                           <td style="width:10%;">
                                               <img class="img-thumbnail" src="'.$wine["image"].'">
                                           <td>
                                           <td>
                                               <span class="wine">'. $wine["name"] .' - ' . $wine["soldwine"] . ' bottles sold</span>
                                           <td>
                                       </tr>';
                                    }
                                }
                           ...
                           <tr>
                               <td colspan="3" style="text-align:center;">
                                   <a href="'.BASE_URL.'jobrating/'.$job_id.'/1" class="btn size" style="background-color:#b2332f;text-decoration:none;color:white;"><img class="staricon" src="'.BASE_URL.'assets/css/images/starIcon.png"><br>Very Poor</a>
                                   <a href="'.BASE_URL.'jobrating/'.$job_id.'/2" class="btn size" style="background-color:#d2643c;text-decoration:none;color:white;"><img class="staricon" src="'.BASE_URL.'assets/css/images/starIcon.png"><br>Poor</a>
                                   <a href="'.BASE_URL.'jobrating/'.$job_id.'/3" class="btn size" style="background-color:#e7b94f;text-decoration:none;color:white;"><img class="staricon" src="'.BASE_URL.'assets/css/images/starIcon.png"><br>Acceptable</a>
                                   <a href="'.BASE_URL.'jobrating/'.$job_id.'/4" class="btn size" style="background-color:#77a83a;text-decoration:none;color:white;"><img class="staricon" src="'.BASE_URL.'assets/css/images/starIcon.png"><br>Good</a>
                                   <a href="'.BASE_URL.'jobrating/'.$job_id.'/5" class="btn size" style="background-color:#577d2b;text-decoration:none;color:white;"><img class="staricon" src="'.BASE_URL.'assets/css/images/starIcon.png"><br>Very Good</a>
                               </td>
                           </tr>
                           <tr>
                               <td colspan="3">
