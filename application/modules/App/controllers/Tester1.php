...
class Tester extends Application_Controller {
	...
	public function index() {
	    ...
	    $config = $this->init_pagination('App/tester/index/'.$this->uri->assoc_to_uri($pegination_uri).'//page/',11, $total_rows);
        ...
        $data['all_agency'] = $this->Tester_model->get_agency_list();
        echo "<pre>";
    ...
    public function delete($id = null) {
        ...
        {
            $this->session->set_flashdata('message_type', 'danger');
                $this->session->set_flashdata('message', '<strong>Oh snap!</strong> The tester has assotiated with job.');
        }
    	redirect('/App/tester');
    }
