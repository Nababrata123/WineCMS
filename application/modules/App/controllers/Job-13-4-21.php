                ...
                if($count_job == 0)
                {
                    ...
                    if ($taster_id != ''){
                        ...
                        if($taster_id==$pre_taster){
                            ...
                            $this->mail_template->update_job_email($name,$email, $pre_tasting_date, $pre_start_time, $pre_end_time, $pre_store_data, $currentjobData, $currentStoreData, $wineNames, $salesrep_name);
                            $notifications = $this->Notifications_model->send_notifications_for_change_info($pre_taster,$job_id);
