...
class Agency extends Application_Controller {
    ...
    public function add() {
               ...
               // print_r($meta);die;
                ...
                if($response==0)
                {
                    ...
                    if ($user_id = $this->Agency_model->insert($this->tablename, $user)) {
                        ...
                        $link="https://wine.managed.center/agency";
                        // Send Email to users
        ...
        $data['page'] = 'agency';
    	$data['page_title'] = SITE_NAME.' :: Agency Management &raquo; Add Sales Representative';
    ...
    function view_user_details()
    {
        ...
        foreach($data['user']->meta as $meta)
        {
            if($meta->meta_key=='zone')
            {
                ...
                $zone_name=$this->Agency_model->get_zone_name($zone_id);
                    
                
                $meta->meta_value=$zone_name;
            }
        }
