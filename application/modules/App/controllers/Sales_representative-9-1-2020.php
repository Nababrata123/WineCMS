...
class Sales_representative extends Application_Controller {
    ...
    public function delete($id = null) {
        ...
        {
            $this->session->set_flashdata('message_type', 'danger');
                $this->session->set_flashdata('message', '<strong>Oh snap!</strong> The sales rep is assotiated with job.');
        }
    ...
    public function temp_delete($id = null)
    {
        ...
        {
            $this->session->set_flashdata('message_type', 'danger');
                $this->session->set_flashdata('message', '<strong>Oh snap!</strong> The sales is assotiated with job.');
        }
