	...
	<div class="col-sm-6">
		<fieldset>
            ...
            <div class="form-group" >
		  		...
		  		<div class="col-sm-7">
			  		<input type="number" name="meta[tasters_rate]"  min="1" class="form-control" id="tasters_rate" placeholder="Enter tasters rate" value="<?php if(isset($user_meta['tasters_rate'])){echo $user_meta['tasters_rate'];}?>" required>
