...
<div class="container-fluid main">
	...
	<fieldset>
		...
		<div class="row" style="margin-top: 25px;">
                        ...
                        <div class="col-md-10">
                        <input Type="text" id="search_text" style="width: 27%;" class="form-control" name="search_text" placeholder="Store Address" autocomplete="off" value="<?php if (isset($filter['search_text']) && $filter['search_text']!="~") {echo urldecode($filter['search_text']);}?>">
                        </div>
        </div>
		<div class="row">
	            ...
	            <tr>
	            	...
	            	<td>
	            		...
	            		<?php
                            ...
                            $your_date = date('m/d/Y',strtotime($item->tasting_date));
                            //echo $your_date.'///'.$now;die;
	            	...
	            	<td>
	            		<?php
	            			if($item->status=='approved' || $item->status=='problems')
	            			{
	            		?>
	            				<!--<span class="label label-success">Job is already approved</span>-->
								<a class="btn btn-success btn-xs" href="javascript:void(0)" title="Assign tester" class="activity_button" onclick="open_tester_assign_modal(<?php echo $item->id;?>,<?php echo $this->session->userdata('id');?>)">
...
<script type="text/javascript">
	...
	function open_tester_assign_modal(job_id,user_id)
	{
		$.ajax({
		   type:'POST',
