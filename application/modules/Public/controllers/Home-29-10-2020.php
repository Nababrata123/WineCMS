...
class Home extends Front_Controller {
	...
	*/
	...
	public function job_rating(){
		...
		$data['wineNames'] = $this->Job_model->get_wine_names($job_id);
	...
	public function submit_rating() {
		...
		$m_result=$this->db->get()->row_array();
			...
			if ($this->db->insert('job_rating', $insData)) {
				...
				$this->email_to_user('rh.avalgate@gmail.com', 'Wine Sampling - '.$tastingDate, $dataforadmin); //admin mail 
	...
	public function jobRatingMailTemplate($job_id, $manager_name, $samplingDate, $tasterName, $startTime, $finish_time, $wineNames, $stars, $feedback)
    {
        ...
        <form>
         ...
         <div id="over" style="padding-left:45%;">
