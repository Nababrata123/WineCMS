   ...
   <div class="profile-content">
    ...
    if(!empty($videoData)){
      ...
      <div class="row lib-list">
        <div class="col-lg-5 col-md-5 col-sm-12 videoimg-s">
          ...
          <a href="javascript:void(0)" class="mvideo" data-id="<?php echo $val->photo_id;?>" data-title="<?php echo $val->title;?>" data-token="<?php echo $val->token;?>" data-user-id="<?php echo $this->session->userdata('id'); ?>" data-src="<?php echo base_url('account/check_saveUnsave/'); ?>">
            <span class="play-icon"><img src="https://mvp.managed.center/assets/images/play.png" class="img-fluid" alt="" border="0"></span>
          </a>
        ...
        <div class="col-lg-2 col-md-2 col-sm-12"><div class="level">Level <?php echo $val->difficulty; ?></div></div>
      </div>
    <?php
       } 
     }else{
