...
class Mail_template {
    ...
    //New invitation email for agency
    public function new_user_email_agency($name = NULL, $email = NULL, $password = NULL,$activation_link=NULL) {
        ...
        $message .= "<p>Follow the link below to login your portal. </p>";
//message .= "<p><a href='".$activation_link."' target='".$target."' rel='".$rel."'>".$activation_link."</a></p><br /><br />";
        $colour="red";
        $message.="<p><font color='".$colour."'>** Copy the link and open the link in different browser or private window **</font></p><br/>";

        $message.="<p>".$activation_link."</p><br/><br/>";
...
<!-- /footer -->
   ...
   //Assign job to tester or agency
   public function assigned_job_email($name = NULL, $email = NULL, $samplingDate = NULL, $startTime = NULL, $finish_time = NULL, $wineNames = NULL, $store_name = NULL, $store_address = NULL, $salesrep_name = NULL) {
    ...
    // $message = "<p><strong>Dear ".$name.",</strong><br/></p>
            ...
            $message = "<p><strong>Dear ".$name.",</strong><br/></p>
              <p>A job has been assigned to you.</p><br/>
              <p><strong>JOB INFO : </strong></p>
              <p>Tasting Date - ".$samplingDate."</p>
              <p>Store name & address - ".$store_name.", ".$store_address."</p>
              <p>Sales rep - ".$salesrep_name."</p>
              <p>Job start time - ".$startTime."</p>
              <p>Job end time - ".$finish_time."</p>
              <p><strong>WINE INFO : </strong><br/></p>
              <table>";
              if (!empty($wineNames)) {
    ...
    public function cancelled_job_email($name = NULL, $email = NULL) {
        ...
        $message = "<p><strong>Dear ".$name.",</strong><br/></p>
                <p>Your job has been canceled by the admin."."<br/></p>";
        //$message .= "<p>Thanks,<br /><i>".$this->CI->lang->line('app_site_name')." Team</i></p>";
    ...
    public function bulk_schedule_notification_mail($name = NULL, $email = NULL,$tasting_date)
    {
        ...
        $message .= "<p>Please assign taster and wines for the job.</p>";
        //$message .= "<p>Thanks,<br /><i>".$this->CI->lang->line('app_site_name')." Team</i></p>";
...
<!-- /footer -->
    ...
    public function update_job_email($name=NULL,$email=NULL, $pre_tasting_date=NULL, $pre_start_time=NULL, $pre_end_time=NULL, $pre_store_data=NULL, $currentjobData=NULL, $currentStoreData=NULL, $wineNames = NULL, $salesrep_name = NULL) 
    {
      ...
      $message = "<p><strong>Dear ".$name.",</strong><br/></p>
      <p>The wine info for this job has been changed by the admin.</p><br/>
      <p><strong>JOB INFO : </strong></p>
      <p>Tasting Date - ".$pre_tasting_date."</p>
      <p>Store name & address - ".$pre_store_data->name.", ".$pre_store_data->adress."</p>
      <p>Sales rep - ".$salesrep_name."</p>
      <p>Job start time - ".date("h:i A", strtotime($currentjobData->start_time))."</p>
      <p>Job end time - ".date("h:i A", strtotime($currentjobData->end_time))."</p>
      <p><strong>WINE INFO : </strong><br/></p>
      <table>";
      if (!empty($wineNames)) {
          foreach ($wineNames as $wine) {
      ...
      // $message = "<p><strong>Dear ".$name.",</strong><br/><br/></p>
      //         <p>The wine info for this job has been changed by the admin."."</p>"."
      //         <p> ". $pre_tasting_date.", ".date("h:i A", strtotime($pre_start_time))." - ".date("h:i A", strtotime($pre_end_time))." at "."
      //         <br/>" .$pre_store_data->name.", ".$pre_store_data->adress." has been updated by the admin.</p>"."<br/> Here is the updated info: "." <br/> "."Start Time- ".date("h:i A", strtotime($currentjobData->start_time))."<br/>". "End Time- ".date("h:i A", strtotime($currentjobData->end_time))."<br/><br/><br/></p>";
     
      $this->email_to_user($email, $name, $this->CI->lang->line('app_site_name').' - Updated Job', $message);
  }

/*
    public function update_job_email($name=NULL,$email=NULL, $pre_tasting_date=NULL, $pre_start_time=NULL, $pre_end_time=NULL, $pre_store_data=NULL, $currentjobData=NULL, $currentStoreData=NULL) 
    {
      ...
      $message = "<p><strong>Dear ".$name.",</strong><br/><br/></p>
              <p>The End Time of your scheduled tasting for "."</p>"."
              <p> ". $pre_tasting_date.", ".date("h:i A", strtotime($pre_start_time))." - ".date("h:i A", strtotime($pre_end_time))." at "."
              <br/>" .$pre_store_data->name.", ".$pre_store_data->adress." has been updated by the admin.</p>"."<br/> Here is the updated info: "." <br/> "."Start Time- ".date("h:i A", strtotime($currentjobData->start_time))."<br/>". "End Time- ".date("h:i A", strtotime($currentjobData->end_time))."<br/><br/><br/></p>";
...
public function email_to_store($to_email = NULL, $subject = NULL, $message = NULL){
  $from = $this->CI->lang->line('app_site_name') . " <" . NO_REPLY_EMAIL . ">";
  //SMTP & mail configuration
  $host = "ssl://smtp.gmail.com";
  $port = "465";
...
public function wine_upload_email($name = NULL, $email = NULL, $uploadDate = NULL, $uploadReport = NULL) {

  if ($email == NULL) {
      return false;
  }
          $message = "<p><strong>Dear Admin,</strong><br/></p>
          <p>Product has been added/updated successfully.</p><br/>
          <p><strong>UPLOAD INFO : </strong></p>
          <p>Upload Date - ".$uploadDate."</p>
          <p>".$uploadReport."</p>";

  $this->email_to_user($email, $name, $this->CI->lang->line('app_site_name').' -  Not inserted products during the upload.', $message);
}
